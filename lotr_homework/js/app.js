...
let theKing = $('aside li:nth-child(4)');
$(theKing).text('Aragorn');
};
...
$('.buddy:nth-of-type(5)').css('text-decoration', 'line-through');
  // 3. Tricky: Remove the Uruk-Hai from the Baddies on the page
$('.baddy:nth-of-type(3)').remove();
};
