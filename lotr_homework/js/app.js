...
const makeMiddleEarth = () => {
  ...
  for(let i = 0; i < lands.length; i++) {
    $('#middle-earth').append('<article id= "cat"></article>');
    $('#cat').append('<h1>"' + lands[i] + '"</h1>');
    $('#cat').attr('id', lands[i]);
  }
...
const makeBaddies = () => {
  ...
  $('#Mordor').append('<ul id="baddiesList"></ul>');
  // 2. give each of the baddies a class of "baddy"
  for(let i = 0; i < baddies.length; i++) {
    $('#baddiesList').append('<li>"' + baddies[i] + '"</li>');
  }
...
const makeBuddies = () => {
  ...
  $('#middle-earth').append('<aside id="buddiesAside"></aside>');
  // 2. display an unordered list of buddies in the aside
  $('#buddiesAside').append('<ul id="buddiesList"></ul>');
...
const theBalrog = () => {
  ...
  $('#buddiesList').contents().eq(0).replaceWith('<li class="the-white">"Gandalf the White"</li>');
...
const itsDangerousToGoAlone = () => {
  ...
  $('#hobbitList').contents().eq(0).appendTo('#Mordor');
  $('#hobbitList').contents().eq(0).appendTo('#Mordor');
