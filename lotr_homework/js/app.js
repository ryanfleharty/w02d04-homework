...
const keepItSecretKeepItSafe = () => {
  ...
  if (this.innerText === "frodo baggins") {
    console.log("Inside Frodo!!");
    $(this).append("<div id='the-ring'></div>");
  }
  })
...
const itsDangerousToGoAlone = () => {
  ...
  $('.hobbit').each(function(){
    console.log(this.innerText);
    if (this.innerText === "frodo baggins" || this.innerText === "samwise 'sam' gamgee") {
      console.log(this);
...
const thereAndBackAgain = () => {
  ...
  $('.hobbit').each(function(){
    $(this).detach().appendTo("#The-Shire");
  })
};
